...
if( Use_Cor == 'YES' ){
  ...
  ENRICH_OBJ <-  syn_temp$store( synapseclient$File( path='~/igraphNetworkExpansion/code/FullNetwork_NoEstimator.RData', name = 'FullNetwork_NoEstimator.RData', parentId=CODE$properties$id ), used = Syns_Used, activityName = activityName, activityDescription = activityDescription)

  ENRICH_OBJ <-  syn_temp$store( synapseclient$File( path='~/igraphNetworkExpansion/code/FullNetwork_JS_Estimator.RData', name = 'FullNetwork_JS_Estimator.RData', parentId=CODE$properties$id ), used = Syns_Used, activityName = activityName, activityDescription = activityDescription)
  
  ENRICH_OBJ <-  syn_temp$store( synapseclient$File( path='~/igraphNetworkExpansion/code/DirectedFullNetwork_NoEstimator.RData', name = 'DirectedFullNetwork_NoEstimator.RDataFullNetwork_NoEstimator.RData', parentId=CODE$properties$id ), used = Syns_Used, activityName = activityName, activityDescription = activityDescription)

  ENRICH_OBJ <-  syn_temp$store( synapseclient$File( path='~/igraphNetworkExpansion/code/DirectedFullNetwork_JS_Estimator.RData', name = 'DirectedFullNetwork_JS_Estimator.RData', parentId=CODE$properties$id ), used = Syns_Used, activityName = activityName, activityDescription = activityDescription)
