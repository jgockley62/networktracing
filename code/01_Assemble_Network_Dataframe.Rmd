...
ENRICH_OBJ <-  syn_temp$store( synapseclient$File( path='01_Assemble_Network_Dataframe.Rmd', name = 'Genes In Pathway Commons', parentId=CODE$properties$id ), used = Syns_Used, activityName = activityName, activityDescription = activityDescription)
